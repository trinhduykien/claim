...
Insurance - Đánh giá tiếp nhận bồi thường V.0.6
...
if current_product and not st.session_state.finished:
    ...
    if not (last_msg and last_msg["role"] == "assistant" and "KẾT QUẢ" in last_msg["content"]):
        ...
        if result["passed"]:
            ...
            detail = "Hồ sơ của anh/chị đã đủ điều kiện để tiếp nhận bồi thường. Vui lòng liên hệ để được hướng dẫn nộp hồ sơ chính thức."
    ...
    if ai_result["success"]:
        ...
        if not ai_text or not ai_text.strip():
            ai_text = ("AI đã xử lý nhưng không trả về nội dung. "
                       "Vui lòng liên hệ qua tổng đài 1900 54 54 55 "
...
"""
        ...
        add_message("assistant", (
            ...
            "Anh/chị có thể thử lại sau hoặc liên hệ qua tổng đài 1900 54 54 55 "
            ...
            with qr_col4:
                ...
                if st.button(quick_labels[3], key=f"qr_{len(st.session_state.messages)}_3"):
                    ...
                    add_message("assistant", (
                        ...
                        "1. Website: https://www..com.vn → \"Tra cứu hồ sơ\"\n"
...
if st.session_state.get("show_rating_widget", False) and st.session_state.waiting_for_continue_choice:
    ...
    st.markdown("**Đánh giá trải nghiệm với trợ lý ảo :**")
    ...
    if st.button(" Xác nhận", key="welcome_confirm_btn", use_container_width=True):
        ...
        if "Đánh giá điều kiện tiếp nhận" in welcome_selected:
            ...
            add_message("assistant", (
                ...
                "Dạ! Tôi có thể tư vấn về các sản phẩm bảo hiểm .\n\n"
            ...
            add_message("assistant", (
                ...
                "1. Truy cập website https://www..com.vn, mục \"Tra cứu hồ sơ\"\n"
            ...
            add_message("assistant", (
                ...
                "Dạ! Để tìm đại lý/văn phòng gần nhất, anh/chị có thể:\n\n"

                "1. Truy cập website https://www..com.vn, mục \"Mạng lưới\"\n"

                "2. Gọi tổng đài 1900 54 54 55 để định vị văn phòng gần nhất\n"

                "3. Tìm kiếm \"+ tên tỉnh/thành phố\" trên Google Maps\n\n"

                "có văn phòng trên toàn bộ 63 tỉnh thành. Anh/chị đang ở tỉnh/thành phố nào ạ?"
            ...
            add_message("assistant", (
                ...
                "Dạ! Anh/chị muốn **đánh giá trải nghiệm** với trợ lý ảo .\n\n"
    ...
    if st.button(" Xác nhận", key="faq_confirm_btn", use_container_width=True):
        ...
        if "Quy trình" in faq_selected:
            ...
            add_message("assistant", (
                ...
                "1. Thông báo sự cố cho (trong thời hạn quy định)\n"
            ...
            add_message("assistant", (
                ...
                "1. Liên hệ để phản ánh kết quả thẩm định\n"

                "2. sẽ xem xét lại hồ sơ trong vòng 15 ngày\n"
            ...
            add_message("assistant", (
                ...
                "Để nói chuyện với nhân viên , anh/chị vui lòng:\n\n"
            ...
            add_message("assistant", (
                ...
                "- thường có chương trình ưu đãi theo thời gian và đối tượng khách hàng\n\n"

                "- Vui lòng liên hệ tổng đài 1900 54 54 55 hoặc xem website https://www..com.vn\n\n"
            ...
            add_message("assistant", (
                ...
                "- Anh/chị có thể liên hệ để hủy hoặc đổi sản phẩm bảo hiểm\n"
            ...
            add_message("assistant", (
                ...
                "- Anh/chị có thể liên hệ để cập nhật thông tin (chuyển nhà, đổi SĐT, đổi tên...)\n"
...
# CITY CHOICE SELECTBOX — Chọn tỉnh/thành phố để tìm văn phòng 
...
if st.session_state.waiting_for_city_choice and not st.session_state.current_product and not st.session_state.waiting_for_text:
    ...
    if st.button(" Xác nhận", key="city_confirm_btn", use_container_width=True):
        ...
        if offices:
            ...
            office_text = f"Dạ! Đây là danh sách văn phòng tại **{city_selected}**:\n\n"
            ...
            add_message("assistant", (
                ...
                f"Xin lỗi, tôi chưa tìm thấy văn phòng tại **{city_selected}**.\n\n"
    ...
    if st.button(" Xác nhận", key="continue_confirm_btn", use_container_width=True):
        ...
        if continue_selected == "Có":
            ...
            add_message("assistant", (
                ...
                "Cảm ơn anh/chị đã sử dụng dịch vụ của ! Chúc anh/chị một ngày tốt lành!"
        ...
        if aiml_resp and aiml_resp.startswith("__CLAIM_REQUEST__"):
            ...
            if has_incident(user_input) or has_claim_request(user_input):
                ...
                add_message("assistant", (
                    ...
                    "hoặc hỏi tôi bất cứ điều gì về ! "
                ...
                for o in _OFFICES_LIST:
                    ...
                    for alt in o.get("alt_names", []):
                        ...
                        if alt_n in text_n or text_n in alt_n:
                            matched_city = o["city"]
                            break
                office_text = f"Dạ! Đây là danh sách văn phòng tại **{matched_city}**:\n\n"
                for i, office in enumerate(offices, 1):
                    office_text += f"**{i}. {office['name']}**\n"
                    office_text += f"   Địa chỉ: {office['address']}\n"
                    office_text += f"   Điện thoại: {office['phone']}\n\n"
            ...
            if greeting:
                ...
                if not st.session_state.asked_name:
                    ...
                    add_message("assistant", (
                        ...
                        "Xin chào! Cảm ơn anh/chị đã liên hệ .\n\n"
